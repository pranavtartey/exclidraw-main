...
const Navbar: FC = () => {
  ...
  return (
    <div className="flex items-center justify-between border border-neutral-500 rounded-lg px-4 py-1 shadow-[0_1px_14px_#DDD] bg-black/30 backdrop-blur-md">
      ...
      <div>
        ...
        >
          {clicked ? <IconMenu2 color="#dedede" /> : <IconX color="#dedede" />}
        </div>
      </div>
    </div>
  );
